...
ActiveRecord::Schema.define(:version => 20120417213953) do
  ...
  create_table "imentore_dealers", :force => true do |t|
  ...
  create_table "imentore_projects", :force => true do |t|
    t.string  "name"
  ...
  create_table "imentore_proposes", :force => true do |t|
    t.string  "value"
    t.string  "description"
  ...
  create_table "imentore_talents", :force => true do |t|
    t.string  "name"
    t.string  "kind"
    t.string  "experience"
    t.string  "resume"
